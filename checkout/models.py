"""Create the Order and OrderLineItem Models
"""
import uuid
...
class Order(models.Model):
    ...
    is_card = models.BooleanField(default=False, null=True, blank=True)
    message = models.TextField(max_length=200, default="", blank=True)
    sliced = models.BooleanField(default=False, null=True, blank=True)
    ...
    grand_total = models.DecimalField(max_digits=10, decimal_places=2,
                                      null=False, default=0)
    shopping_bag = models.TextField(null=False, blank=False, default='')
...
class OrderLineItem(models.Model):
    ...
    forsix = models.CharField(max_length=20, default="", blank=True)
